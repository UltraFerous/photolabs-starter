  ...
  return (
    <div className="photo-details-modal">
      ...
      <div className="photo-details-modal__images">
        <PhotoFavButton likedChecker={props.likedChecker} changeLike={props.changeLike} item={props.item} liked={props.liked} setLikedPicture={props.setLikedPicture} />
        ...
        <div className="photo-details-modal__image" >
          <PhotoList likedChecker={props.likedChecker} changeLike={props.changeLike} photos={similarPhotos} liked={props.liked} setLikedPicture={props.setLikedPicture} openPreview = {props.openPreview}/>
        </div>
      </div>
    </div>
  );
